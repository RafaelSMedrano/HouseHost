import { createGuest, deleteGuest, findGuestById, updateGuest } from "../api.js?v=2026-05-17-01";
    ...
    <form id="guest-form" class="guest-form">
      <section class="guest-section">
        ...
        <div class="guest-fields">
          ...
          ${selectField("guestType", "Tipo", ["regular", "vip", "new"], null, { regular: "Regular", vip: "VIP", new: "Novo" })}
      ...
      <section id="guest-danger-zone" class="guest-danger-zone ${isEdit ? "" : "hidden"}">
...
async function loadGuest(container, state) {
    try {
        const response = await findGuestById(state.guestId);
...
function updatePreview(container, state) {
    ...
    if (type === "new") badges.push('<span class="guest-preview-badge new">Novo</span>');
