import { findAllGuests, findAllRooms, findBookingById, updateBooking } from "../api.js?v=2026-05-20-edit-reservation";
...
const statuses = [
    ...
    { value: "GOT_CHECKIN", label: "Check-in realizado" },
...
function fillForm(container, booking) {
    ...
    setValue(container, "status", booking.status || "PENDING");
...
function collectPayload(container) {
    return {
        ...
        status: value(container, "status") || "PENDING",
