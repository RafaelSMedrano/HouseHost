import { registration } from "../api.js?v=2026-05-20-user-role";
            ...
            <form id="registrationForm">
                ...
                <div class="field">
                    ...
                    <div class="input-wrap">
                        ...
                        <select class="field-input" id="rw-role" required>
                            <option value="CEO">Chefe Executivo Organizacional (CEO)</option>
                            <option value="CTO">Diretor Geral de Tecnologia (CTO)</option>
