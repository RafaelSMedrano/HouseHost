import { createSupplier, findSupplierById, updateSupplier } from "../api.js?v=2026-07-26-supplier-management";
...
export function renderSupplierFormView(containerId, options = {}) {
    ...
    container.innerHTML = `<main class="main supplier-main"><form class="supplier-page supplier-form" data-supplier-form>
      <header class="supplier-header"><div><span>Inventário interno</span><h1>${options.supplierId ? "Editar" : "Novo"} fornecedor</h1><p>Cadastre a empresa uma vez e detalhe cada serviço separadamente.</p></div><button class="dashboard-back-btn" type="button" data-cancel>Voltar</button></header>
