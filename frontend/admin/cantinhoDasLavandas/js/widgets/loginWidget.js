import { ApiError, findQuickAccessUsers, login, saveAuthSession } from "../api.js?v=2026-07-26-login-restriction-feedback"; /*  O usuário pode estar na casa dele com o navegador guardando um arquivo antigo em cache por horas, dias ou até mais, dependendo das regras de cache do servidor/
                                                       navegador.
