    ...
    try {
        ...
        profileContainer.innerHTML = `
          <div class="privacy-governance-state error">
            ...
            <button class="dashboard-back-btn" type="button" data-back-processing-operations aria-label="Voltar ao inventário">Voltar ao inventário</button>
          </div>`;
        profileContainer.querySelector("[data-back-processing-operations]")
                ?.addEventListener("click", () => options.onBack?.());
    }
...
export function buildOperationProfileMarkup(operation, assessmentList = [], options = {}) {
    ...
    return `
      <header class="privacy-governance-header privacy-operation-profile-header">
        <div>
          <button class="dashboard-back-btn" type="button" data-back-processing-operations aria-label="Voltar"><i class="ti ti-arrow-left" aria-hidden="true"></i>Voltar</button>
