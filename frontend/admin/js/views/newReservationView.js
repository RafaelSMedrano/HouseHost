import { createBookingFromForm, findAllBookings, findAllRooms, findGuestsByDocumentNumber, findGuestsByName } from "../api.js?v=2026-05-18-rooms";
  ...
  <div class="new-reservation-content">
    ...
    <form id="new-reservation-form" class="new-reservation-form">
      ...
      <section class="booking-section open">
        ...
        <div class="booking-section-body">
          <div class="booking-fields">
            <label class="booking-field no-icon"><span>Forma de pagamento <strong>*</strong></span><div><select id="paymentMethod" required><option value="" disabled selected>Selecione</option><option value="PIX">Pix</option><option value="CREDIT_CARD">Cartao de credito</option><option value="DEBIT_CARD">Cartao de debito</option><option value="CASH">Dinheiro</option><option value="BANK_TRANSFER">Transferencia bancaria</option><option value="BOOKING">Booking</option><option value="AIRBNB">Airbnb</option></select></div></label>
...
async function setupGuestLookup(container) {
    const state = { guests: [], activeField: null, requestId: 0 };
