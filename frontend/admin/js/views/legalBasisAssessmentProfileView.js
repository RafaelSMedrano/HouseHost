...
export function renderLegalBasisAssessmentProfileView(containerId, options = {}) {
    ...
    container.innerHTML = `<main class="main privacy-governance-main privacy-governance-profile-main"><div class="privacy-governance-page">
      ...
      <div data-legal-basis-profile aria-busy="true"><div class="privacy-governance-state loading"><i class="ti ti-loader-2"></i><p>Carregando o perfil da avaliação...</p></div></div>
    </div></main>`;
...
async function loadProfile(container, options) {
    ...
    try {
        ...
        profile.innerHTML = `<div class="privacy-governance-state error"><i class="ti ti-alert-triangle"></i><p>${escapeGovernanceHtml(feedback.textContent)}</p><button class="dashboard-back-btn" type="button" data-assessment-back>Voltar</button></div>`;
...
export function buildLegalBasisAssessmentProfileMarkup(assessment, operation = {}) {
    return `<header class="privacy-governance-header privacy-operation-profile-header"><div>
      <button class="dashboard-back-btn" type="button" data-assessment-back><i class="ti ti-arrow-left"></i>Voltar</button>
