...
public class FinancialTransactionController {
    ...
    private final FinancialTransactionUseCase financialTransactionService;

    public FinancialTransactionController(FinancialTransactionUseCase financialTransactionService) {
