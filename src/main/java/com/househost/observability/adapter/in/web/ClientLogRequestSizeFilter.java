...
public class ClientLogRequestSizeFilter extends OncePerRequestFilter {

    static final int MAX_REQUEST_BYTES = 16 * 1024;

    @Override
    protected boolean shouldNotFilter(HttpServletRequest request) {
        String endpoint = request.getContextPath() + "/client-logs";
    ...
    protected void doFilterInternal(
        ...
        byte[] requestBody = request.getInputStream().readNBytes(MAX_REQUEST_BYTES + 1);
    ...
    private void reject(HttpServletResponse response) throws IOException {
        ...
        response.getWriter().write(
                "{\"status\":\"error\",\"message\":\"Log do cliente excede o limite de 16 KiB.\",\"data\":null}"
        );
    }
    ...
    private static final class CachedBodyRequest extends HttpServletRequestWrapper {
        ...
        @Override
        public long getContentLengthLong() { return requestBody.length; }
    }
