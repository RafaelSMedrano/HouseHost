...
public class BookingResponseDTO {
    ...
    public BookingResponseDTO(Booking booking) {
        ...
        this.privacyPolicyVersion = booking.getPrivacyPolicyVersion();
        this.privacyPolicyContentHash = booking.getPrivacyPolicyContentHash();
        this.termsVersion = booking.getTermsVersion();
        this.privacyAcceptedAt = booking.getPrivacyAcceptedAt();
        this.marketingOptIn = booking.getMarketingOptIn();
        this.marketingOptInAt = booking.getMarketingOptInAt();
